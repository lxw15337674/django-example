...
class AbstractUser(AbstractBaseUser, PermissionsMixin):
    ...
    user_type = models.ForeignKey(
        ContentType, on_delete=models.SET_NULL, null=True, editable=False)
...
class User(AbstractUser):
    ...
    """
    name = models.CharField(max_length=20, default="没名没姓的人")
    sex = models.CharField(max_length=3, default="男")
    birthday = models.CharField(max_length=20, default='1994-11-08')
    company = models.CharField(max_length=30, default='工程师')
    ...
    phone = models.CharField(max_length=30, default='18393905493')
