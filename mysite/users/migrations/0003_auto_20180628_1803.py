# Generated by Django 2.0.6 on 2018-06-28 10:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='user',
            name='birthday',
            field=models.CharField(default='1994-11-08', max_length=20),
        ),
        migrations.AddField(
            model_name='user',
            name='graduate_time',
        ...
        migrations.AddField(
            model_name='user',
            name='id_number',
            field=models.CharField(default='411330199411081531', max_length=30),
        ),
        migrations.AddField(
            model_name='user',
            name='job',
        ...
        migrations.AddField(
            model_name='user',
            name='name',
            field=models.CharField(default='没名没姓的人', max_length=20),
        ),
        migrations.AddField(
            model_name='user',
            name='phone',
